	...
	public void gameResult(String player) {
		...
		try {
			...
			do {
				...
				if (this.slotNum1 == 7 && this.slotNum2 == 7 && this.slotNum3 == 7) {
				...
				} else if (this.slotNum1 == this.slotNum2 && this.slotNum1 == this.slotNum3
						&& this.slotNum2 == this.slotNum3) {

					System.out.println(
							"==================================================================================================================");
					System.out.println("플레이어의 이름 : " + player + "\n나온 번호 :" + " [" + slotNum1 + "] " + "[" + slotNum2
							+ "] " + "[" + slotNum3 + "] ");
			...
			if (this.slotNum1 != this.slotNum2 || this.slotNum1 != this.slotNum3 || this.slotNum2 != this.slotNum3) {
